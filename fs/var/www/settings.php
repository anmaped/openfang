...
<div class="box" id="tab_container">
    <div class="container_item is-active" data-item="1">
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>HTTP Password</p>
            </header>
            <div class='card-content'>
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>LED</p>
            </header>
            <div class='card-content'>
                <div class="columns">
                    <div class="column">
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Version (last commit date from GitHub/autoupdate script)</p>
            </header>
            <div class='card-content'>
                <p><?php echo shell_exec('cat /opt/version'); ?></p>
            </div>
        </div>
    </div>
    <div class="container_item" data-item="2">
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>IR</p>
            </header>
            <div class='card-content'>
                <div class="columns">
                    <div class="column">
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Auto Night Mode</p>
            </header>
            <div class='card-content'>
                <div class="columns">
                    <div class="column">
                            ...
                            <div class="field is-grouped">
                                <div class="control">
                                    <div class="select">
                                        ...
                                        <option value="1" <?php echo shell_exec('if [ "$(sed s/AVG=// /opt/config/ldr-average.conf)" -eq 1 ]; then echo selected; fi'); ?>>1</option>
                                        <option value="2" <?php echo shell_exec('if [ "$(sed s/AVG=// /opt/config/ldr-average.conf)" -eq 2 ]; then echo selected; fi'); ?>>2</option>
                                        <option value="3" <?php echo shell_exec('if [ "$(sed s/AVG=// /opt/config/ldr-average.conf)" -eq 3 ]; then echo selected; fi'); ?>>3</option>
                                        <option value="4" <?php echo shell_exec('if [ "$(sed s/AVG=// /opt/config/ldr-average.conf)" -eq 4 ]; then echo selected; fi'); ?>>4</option>
                                        <option value="5" <?php echo shell_exec('if [ "$(sed s/AVG=// /opt/config/ldr-average.conf)" -eq 5 ]; then echo selected; fi'); ?>>5</option>
                                        <option value="10" <?php echo shell_exec('if [ "$(sed s/AVG=// /opt/config/ldr-average.conf)" -eq 10 ]; then echo selected; fi'); ?>>10</option>
                                        <option value="15" <?php echo shell_exec('if [ "$(sed s/AVG=// /opt/config/ldr-average.conf)" -eq 15 ]; then echo selected; fi'); ?>>15</option>
                                        </select>
                                    </div>
                                </div>
                                <p class="control">
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>RTSP</p>
            </header>
            <div class='card-content'>
                <div class="columns">
                    <div class="column">
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Video Settings</p>
            </header>
            <div class='card-content'>
                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <div class="select">
                                                ...
                                                <option value="-W640 -H360" <?php echo shell_exec('if [ "$(cat /opt/config/rtspserver.conf | grep 640)" != "" ]; then echo selected; fi'); ?>>640x360</option>
                                                <option value="-W960 -H540" <?php echo shell_exec('if [ "$(cat /opt/config/rtspserver.conf | grep 960)" != "" ]; then echo selected; fi'); ?>>960x540</option>
                                                <option value="-W1280 -H720" <?php echo shell_exec('if [ "$(cat /opt/config/rtspserver.conf | grep 1280)" != "" ]; then echo selected; fi'); ?>>1280x720</option>
                                                <option value="-W1600 -H900" <?php echo shell_exec('if [ "$(cat /opt/config/rtspserver.conf | grep 1600)" != "" ]; then echo selected; fi'); ?>>1600x900</option>
                                                <option value="-W1920 -H1080" <?php echo shell_exec('if [ "$(cat /opt/config/rtspserver.conf | grep 1920)" != "" ]; then echo selected; fi'); ?>>1920x1080</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <div class="select">
                                                ...
                                                <option value="0" <?php echo shell_exec('source /opt/config/rtspserver.conf; if [ "$(echo $VIDEOFORMAT | grep -w 0)" != "" ]; then echo selected; fi'); ?>>FixedQp</option>
                                                <option value="1" <?php echo shell_exec('source /opt/config/rtspserver.conf; if [ "$(echo $VIDEOFORMAT | grep -w 1)" != "" ]; then echo selected; fi'); ?>>CBR</option>
                                                <option value="2" <?php echo shell_exec('source /opt/config/rtspserver.conf; if [ "$(echo $VIDEOFORMAT | grep -w 2)" != "" ]; then echo selected; fi'); ?>>VBR</option>
                                                <option value="3" <?php echo shell_exec('source /opt/config/rtspserver.conf; if [ "$(echo $VIDEOFORMAT | grep -w 3)" != "" ]; then echo selected; fi'); ?>>SMART</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Start H264 RTSP</p>
            </header>
            <div class='card-content'>
                ...
                <p>Path to feed : <a href='rtsp://<?php echo $IP; ?>:8554/unicast'>rtsp://<?php echo $IP; ?>:8554/unicast</a></p>
                <p>HLS : <a href='http://<?php echo $IP; ?>:8554/unicast.m3u8'>http://<?php echo $IP; ?>:8554/unicast.m3u8</a></p>
                <p>MPEG-DASH : <a href='http://<?php echo $IP; ?>:8554/unicast.mpd'>http://<?php echo $IP; ?>:8554/unicast.mpd</a></p>
            </div>
        </div>
        <!-- MJPEG RTSP -->
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Start MJPEG RTSP</p>
            </header>
            <div class='card-content'>
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Timelapse</p>
            </header>
            <div class='card-content'>
    ...
    <div class="container_item" data-item="3">
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>OSD Display</p>
            </header>
            <div class='card-content'>
                <form id="formOSD" action="cgi-bin/action.cgi?cmd=osd" method="post">
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field is-grouped">
                                <p class="control">
                                    <input type="checkbox" name="OSDenable" value="enabled" <?php echo shell_exec('if [ -f /opt/config/osd.conf ]; then echo checked; fi'); ?> />
                                </p>
                                <p class="control">
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field is-grouped">
                                <p class="control">
                                    <input type="checkbox" name="AXISenable" value="enabled" <?php echo shell_exec('if [[ "$(grep DISPLAY_AXIS /opt/config/osd.conf | sed s/DISPLAY_AXIS=//)" == "true" ]];then echo checked; fi'); ?> />
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <div class="select">
                                        <select name="color">
                                        <option value="0" <?php echo shell_exec('if [ "$(grep COLOR /opt/config/osd.conf | sed s/COLOR=//)" -eq 0 ]; then echo selected; fi'); ?>>White</option>
                                        <option value="1" <?php echo shell_exec('if [ "$(grep COLOR /opt/config/osd.conf | sed s/COLOR=//)" -eq 1 ]; then echo selected; fi'); ?>>Black</option>
                                        <option value="2" <?php echo shell_exec('if [ "$(grep COLOR /opt/config/osd.conf | sed s/COLOR=//)" -eq 2 ]; then echo selected; fi'); ?>>Red</option>
                                        <option value="3" <?php echo shell_exec('if [ "$(grep COLOR /opt/config/osd.conf | sed s/COLOR=//)" -eq 3 ]; then echo selected; fi'); ?>>Green</option>
                                        <option value="4" <?php echo shell_exec('if [ "$(grep COLOR /opt/config/osd.conf | sed s/COLOR=//)" -eq 4 ]; then echo selected; fi'); ?>>Blue</option>
                                        <option value="5" <?php echo shell_exec('if [ "$(grep COLOR /opt/config/osd.conf | sed s/COLOR=//)" -eq 5 ]; then echo selected; fi'); ?>>Cyan</option>
                                        <option value="6" <?php echo shell_exec('if [ "$(grep COLOR /opt/config/osd.conf | sed s/COLOR=//)" -eq 6 ]; then echo selected; fi'); ?>>Yellow</option>
                                        <option value="7" <?php echo shell_exec('if [ "$(grep COLOR /opt/config/osd.conf | sed s/COLOR=//)" -eq 7 ]; then echo selected; fi'); ?>>Purple</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <div class="select">
                                        <select name="size">
                                        <option value="0" <?php echo shell_exec('if [ "$(grep SIZE /opt/config/osd.conf | sed s/SIZE=//)" -eq 0 ]; then echo selected; fi'); ?>>Small</option>
                                        <option value="1" <?php echo shell_exec('if [ "$(grep SIZE /opt/config/osd.conf | sed s/SIZE=//)" -eq 1 ]; then echo selected; fi'); ?>>Bigger</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <div class="select">
                                        <select name="fixedw">
                                        <option value="0" <?php echo shell_exec('if [ "$(grep FIXEDW /opt/config/osd.conf | sed s/FIXEDW=//)" -eq 0 ]; then echo selected; fi'); ?>>No</option>
                                        <option value="1" <?php echo shell_exec('if [ "$(grep FIXEDW /opt/config/osd.conf | sed s/FIXEDW=//)" -eq 1 ]; then echo selected; fi'); ?>>Yes</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Display debug info on OSD</p>
            </header>
            <div class='card-content'>
                <button class="button is-link" onClick="call('cgi-bin/scripts.cgi?cmd=start&script=debug-on-osd')">On</button>
                <button class="button is-warning" onClick="call('cgi-bin/scripts.cgi?cmd=stop&script=debug-on-osd')">Off</button>
            </div>
        </div>
    </div>
                    ...
                    <div class="columns">
                        <div class="column">
                            <div class="field is-horizontal">
                                ...
                                <div class="field-body">
                                    <div class="select">
                                        ...
                                        <option value="OFF" <?php echo shell_exec('source /opt/config/rtspserver.conf; if [ "$(echo $AUDIOFORMAT | grep OFF)" != "" ]; then echo selected; fi'); ?>>OFF</option>
                                        <option value="OPUS" <?php echo shell_exec('source /opt/config/rtspserver.conf; if [ "$(echo $AUDIOFORMAT | grep OPUS)" != "" ]; then echo selected; fi'); ?>>OPUS</option>
                                        <option value="PCM"  <?php echo shell_exec('source /opt/config/rtspserver.conf; if [ "$(echo $AUDIOFORMAT | grep -w PCM)" != "" ]; then echo selected; fi'); ?>>PCM</option>
                                        <option value="PCMU" <?php echo shell_exec('source /opt/config/rtspserver.conf; if [ "$(echo $AUDIOFORMAT | grep -w PCMU)" != "" ]; then echo selected; fi'); ?>>PCMU</option>
                                        <option value="MP3-8000" <?php echo shell_exec('source /opt/config/rtspserver.conf; if [ "$(echo $AUDIOFORMAT$AUDIOOUTBR | grep -w MP38000)" != "" ]; then echo selected; fi'); ?>>MP3-8000</option>
                                        <option value="MP3-44100" <?php echo shell_exec('source /opt/config/rtspserver.conf; if [ "$(echo $AUDIOFORMAT$AUDIOOUTBR | grep -w MP344100)" != "" ]; then echo selected; fi'); ?>>MP3-44100</option>
                                        </select>
                                    </div>
                                    <span class="help">
                            ...
                            <div class="field is-horizontal">
                                ...
                                <div class="field-body">
                                    <div class="select">
                                        ...
                                        <option value="0" <?php echo shell_exec('if [ "$(/usr/bin/setconf -g q)" == "0" ]; then echo selected; fi'); ?>>No filter</option>
                                        <option value="1" <?php echo shell_exec('if [ "$(/usr/bin/setconf -g q)" == "1" ]; then echo selected; fi'); ?>>Filter 1</option>
                                        <option value="2" <?php echo shell_exec('if [ "$(/usr/bin/setconf -g q)" == "2" ]; then echo selected; fi'); ?>>Filter 2</option>
                                        <option value="3" <?php echo shell_exec('if [ "$(/usr/bin/setconf -g q)" == "3" ]; then echo selected; fi'); ?>>NS Filter LOW</option>
                                        <option value="4" <?php echo shell_exec('if [ "$(/usr/bin/setconf -g q)" == "4" ]; then echo selected; fi'); ?>>NS Filter MODERATE</option>
                                        <option value="5" <?php echo shell_exec('if [ "$(/usr/bin/setconf -g q)" == "5" ]; then echo selected; fi'); ?>>NS Filter HIGH</option>
                                        <option value="6" <?php echo shell_exec('if [ "$(/usr/bin/setconf -g q)" == "6" ]; then echo selected; fi'); ?>>NS Filter VERY HIGH</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="field is-horizontal">
                                ...
                                <div class="field-body">
                                    <p class="control">
                                        <input type="checkbox" name="HFEnabled" value="enabled" <?php echo shell_exec('if [ "$(setconf -g l)" == "true" ]; then echo checked; fi'); ?>/>
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container_item" data-item="5">
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Motion Detection</p>
            </header>
            <div class='card-content'>
    ...
    <div class="container_item" data-item="6">
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Process List</p>
            </header>
            <div class='card-content'>
                <pre><?php echo shell_exec('ps'); ?></pre>
            </div>
        </div>
        <!-- Mount Points -->
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Mount Points</p>
            </header>
            <div class='card-content'>
                <pre><?php echo shell_exec('mount'); ?></pre>
            </div>
        </div>
        <!-- Disk Status -->
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Disk Status</p>
            </header>
            <div class='card-content'>
                <pre><?php echo shell_exec('df'); ?></pre>
            </div>
            <div class='card-content'>
                <button data-target="cgi-bin/scripts.cgi?cmd=start&amp;script=resize-fs" class="button script_action_start" data-script="resize-fs">Run</button>
            </div>
        </div>
        <!-- Network Information -->
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Network Information</p>
            </header>
            <div class='card-content'>
                <pre>Interfaces:<br/><?php echo shell_exec('ifconfig; echo "Wlan Network:"; iwconfig'); ?></pre>
                <pre>Routes:<br/><?php echo shell_exec('route'); ?></pre>
                <pre>DNS:<br/><?php echo shell_exec('cat /etc/resolv.conf'); ?></pre>
            </div>
        </div>
    </div>
    <div class="container_item" data-item="7">
        ...
        <div class='card status_card'>
            <header class='card-header'>
                <p class='card-header-title'>Select Theme</p>
            </header>
            <div class='card-content'>
                <div class="dropdown-content">
                    ...
                    <a id="theme_choice_1" href="javascript: setTheme('1')" class="theme_choice dropdown-item" data-css="css/bulma-dark.min.css">
                    Dark
                    </a>
...
<script src="scripts/status.cgi.js" type="text/javascript"></script>
